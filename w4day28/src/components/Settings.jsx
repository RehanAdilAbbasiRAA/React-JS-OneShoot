...
import { getUserProfile, setUserProfile, updatePublicInfo } from "../api/dashboardApi";
  ...
  useEffect(() => {
    if (userProfile) {
      ...
      const newProfile = {
        ...
        avatar:
          userProfile.avatar ||
          "https://avatars.githubusercontent.com/u/138215723?v=4",
